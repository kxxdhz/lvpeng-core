package com.lvpeng.commom.utils;
...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {  
        ...
        System.out.println("使用模和指数生成公钥:"+new String(Base64.encode(pubKey.getEncoded())));
        RSAPrivateKey priKey = RSAUtil.getPrivateKey(modulus, private_exponent);  
        System.out.println("使用模和指数生成私钥:"+new String(Base64.encode(priKey.getEncoded())));
        //加密后的密文  
